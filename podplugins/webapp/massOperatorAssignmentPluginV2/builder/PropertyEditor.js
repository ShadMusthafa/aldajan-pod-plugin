sap.ui.define(['sap/dm/dme/podfoundation/control/PropertyEditor'], function(PropertyEditor) {
  ...
  var oPropertyEditor = PropertyEditor.extend('arun.ext.podplugins.massOperatorAssignmentPluginV2.builder.PropertyEditor', {
    constructor: function(sId, mSettings) {
      PropertyEditor.apply(this, arguments);
      this.setI18nKeyPrefix('massOperatorAssignmentPluginV2.');
      this.setResourceBundleName('arun.ext.podplugins.massOperatorAssignmentPluginV2.i18n.builder');
      this.setPluginResourceBundleName('arun.ext.podplugins.massOperatorAssignmentPluginV2.i18n.i18n');
    },

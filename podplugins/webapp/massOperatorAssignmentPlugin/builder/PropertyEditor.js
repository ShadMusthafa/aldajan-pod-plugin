sap.ui.define(['sap/dm/dme/podfoundation/control/PropertyEditor'], function(PropertyEditor) {
  ...
  var oPropertyEditor = PropertyEditor.extend('arun.ext.podplugins.massOperatorAssignmentPlugin.builder.PropertyEditor', {
    constructor: function(sId, mSettings) {
      PropertyEditor.apply(this, arguments);
      this.setI18nKeyPrefix('massOperatorAssignmentPlugin.');
      this.setResourceBundleName('arun.ext.podplugins.massOperatorAssignmentPlugin.i18n.builder');
      this.setPluginResourceBundleName('arun.ext.podplugins.massOperatorAssignmentPlugin.i18n.i18n');
    },
